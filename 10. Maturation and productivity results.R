...
ggsave('Fig3.png', plot=last_plot(),  width=10, height = 6)
...
ggsave('FigA2.png', plot=last_plot(),  width=10, height = 6)
#################################################
...
ggsave(filename = "Fig1.png", plot = last_plot(),width = 9, height = 3 )