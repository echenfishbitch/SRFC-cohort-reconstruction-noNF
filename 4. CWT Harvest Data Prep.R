...
# saveRDS(Cohort, file = "CWT River Harvest FRH.Rds")
#############################################
############## Ocean Harvest ################
#############################################
...
CWT_Recoveries_Ocean<-CWT_Recoveries %>%  
  ...
  filter(sampling_agency != "WDFW") %>%
  filter(sampling_agency != "CDFO") %>%
  filter(sampling_agency != "ADFG") %>%
...
summary(CWT_Recoveries_Ocean$estimated_number) #137 samples do not have estimated numbers or equals
...
Impact<-Impact %>%
  ...
  summarize(Apr2 = sum(`2_4`, na.rm = TRUE),May2 = sum(`2_5`, na.rm = TRUE),
            ...
            Dec2 = sum(`2_12`, na.rm = TRUE), Jan3 = 0, Feb3 = sum(`3_2`, na.rm = TRUE),
...
Impact<-Impact %>%
  ...
  summarize(Apr2 = sum(`2_4`, na.rm = TRUE),May2 = sum(`2_5`, na.rm = TRUE),
            ...
            Jun5= sum(`5_6`, na.rm = TRUE), Jul5 = sum(`5_7`, na.rm = TRUE), Aug5 = sum(`5_8`, na.rm = TRUE),
            Sept5 = sum(`5_9`, na.rm = TRUE), Oct5 = sum(`5_10`, na.rm = TRUE),
            Jun6= sum(`6_6`, na.rm = TRUE) , Jul6= 0,
...
#not needed for specific hatcheries
